...
export const CLOSED_STATUSES: CaseStatus[] = ["COMPLETED", "DECLINED", "CANCELLED"];

export const STATUS_TRANSITIONS: Record<CaseStatus, CaseStatus[]> = {
  NEW_REQUEST: ["UNDER_REVIEW", "NEGOTIATING", "AWAITING_PROVIDER_FEEDBACK", "AWAITING_INTERNAL_APPROVAL", "ESCALATED", "COMPLETED", "DECLINED", "CANCELLED"],
  UNDER_REVIEW: ["NEGOTIATING", "AWAITING_PROVIDER_FEEDBACK", "AWAITING_INTERNAL_APPROVAL", "ESCALATED", "COMPLETED", "DECLINED", "CANCELLED"],
  NEGOTIATING: ["UNDER_REVIEW", "AWAITING_PROVIDER_FEEDBACK", "AWAITING_INTERNAL_APPROVAL", "ESCALATED", "COMPLETED", "DECLINED", "CANCELLED"],
  AWAITING_PROVIDER_FEEDBACK: ["UNDER_REVIEW", "NEGOTIATING", "AWAITING_INTERNAL_APPROVAL", "ESCALATED", "COMPLETED", "DECLINED", "CANCELLED"],
  AWAITING_INTERNAL_APPROVAL: ["UNDER_REVIEW", "NEGOTIATING", "AWAITING_PROVIDER_FEEDBACK", "ESCALATED", "COMPLETED", "DECLINED", "CANCELLED"],
